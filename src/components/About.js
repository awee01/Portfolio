...
const About = () => {
    return (
        ...
        <section className="hero" classId="About-Me">
        <div className="hero-title">
            <h2>About Me</h2>
        
            <p>
                My Name is Adi Wee. I am currently a student in the University of Toronto Computer
                Science bootcamp, learning how to code for the first time. I am mostly a beginner but am looking to constantly improve
